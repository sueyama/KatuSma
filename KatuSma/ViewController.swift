...
//  KatuSma
//
//  Created by 上山　俊佑 on 2018/05/08.
...
class ViewController: UIViewController {
    ...
    func initSegmentControl() {
        ...
        segmentControl.segments = [
            TextSegment(text: "Skincare"),
            TextSegment(text: "Disease"),
            TextSegment(text: "Bodycare"),
            TextSegment(text: "Health"),
            TextSegment(text: "Beautydiet"),
        ]
        ...
        segmentControl.segmentMinWidth = 10.0
    }
