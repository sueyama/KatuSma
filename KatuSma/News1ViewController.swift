...
class News1ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIWebViewDelegate, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        // xmlを解析する
        let url:String = "https://rss.allabout.co.jp/aa/latest/ch/ch_skincare/"
